...
const PROJECTS = [
  ...
  },
  {
    ...
    title: "Миграция и редизайн сайта esus.ru",
    role: "Digital Project Lead",
    tags: ["Миграция на Drupal", "Редизайн", "UX", "B2B каталог"],
    challenge: "Сильно устаревшие CMS и дизайн.",
    actions: "Перенесли с самописной CMS на Drupal, обновили структуру и дизайн, добавили адаптив.",
    results: "Современный адаптивный сайт c удобной навигацией и системой управления контентом.",
    link: "/cases/esus",
  },
  {
    id: 3,
